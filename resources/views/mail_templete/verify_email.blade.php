...
<div class="preheader" style="font-size: 1px; display: none !important;">Account Activation Localhost.test</div>
                                                                        ...
                                                                        <table cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr>
                                                                                <td class="featured-story__copy" style="background: #fff;" width="640" align="center">
                                                                                    <table cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 16px; line-height: 22px; color: #555555; padding-top: 16px;" align="left">Thanks for creating an pc-locahost.test account. Now, Please click on the below link to verify your email address and complete your verification:
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <a href="http://localhost:8000/confirm_email/{{ $data['hash_key'] }}"  style="background: #0c99d5; color: #fff; text-decoration: none; border: 14px solid #0c99d5; border-left-width: 50px; border-right-width: 50px; text-transform: uppercase; display: inline-block;">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                               <p>
                                                                                                   This link will be expired in 30 min from the time this email was sent.
                                                                                                   Your sincerely,
                                                                                                   Team localhost.test
                                                                                               </p>
                                                                                            </td>
